...
const translations = {
    en: {
        ...
        'macro.factor.oil_prices_desc': 'Rising oil prices increase costs for transportation, manufacturing, and utilities',
        'macro.factor.interest_rates': 'Interest Rates',
        'macro.factor.interest_rates_desc': 'Higher interest rates increase borrowing costs, affecting real estate and banking',
        'macro.factor.exchange_rate': 'USD/VND Exchange Rate',
        'macro.factor.exchange_rate_desc': 'Weaker VND benefits exporters but increases import costs',
        'macro.factor.china_growth': 'China Economic Growth',
        'macro.factor.china_growth_desc': 'China slowdown affects Vietnam exports and manufacturing',
    ...
    vi: {
        ...
        'settings.api_key_placeholder': 'Nhập khóa API của bạn',
        ...
        'macro.factor.oil_prices_desc': 'Giá dầu tăng làm tăng chi phí vận tải, sản xuất và tiện ích',
        'macro.factor.interest_rates': 'Lãi Suất',
        'macro.factor.interest_rates_desc': 'Lãi suất cao hơn tăng chi phí vay, ảnh hưởng đến bất động sản và ngân hàng',
        'macro.factor.exchange_rate': 'Tỷ Giá USD/VND',
        'macro.factor.exchange_rate_desc': 'VND yếu có lợi cho xuất khẩu nhưng tăng chi phí nhập khẩu',
        'macro.factor.china_growth': 'Tăng Trưởng Kinh Tế Trung Quốc',
        'macro.factor.china_growth_desc': 'Trung Quốc chậm lại ảnh hưởng đến xuất khẩu và sản xuất Việt Nam',
